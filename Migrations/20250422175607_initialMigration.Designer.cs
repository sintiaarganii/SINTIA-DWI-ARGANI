...
namespace SINTIA_DWI_ARGANI.Migrations
{
    ...
    [Migration("20250422175607_initialMigration")]
            ...
            modelBuilder.Entity("SINTIA_DWI_ARGANI.Models.DB.Cashier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierStatus = 0,
                            CreatedAt = new DateTime(2025, 4, 22, 17, 56, 5, 306, DateTimeKind.Utc).AddTicks(7660),
                            Name = "Administrator",
                            PasswordHash = "Ij2nSbapTRk6JU0bO+H/lvF6e+25CyMjeoHbFm4rTOM10JgejLjQHGtgLclwf9GO0iXf/7Vk0Ei6y1KY6lfsYg==",
                            Role = "Admin",
                            Salt = "2QEz1h2XA+GeAtPFn1E/JQ==",
                            Username = "admin"
                        });
                });
