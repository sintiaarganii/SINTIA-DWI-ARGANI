...
namespace SINTIA_DWI_ARGANI.Migrations
{
    ...
    [Migration("20250423104154_AddedDTOOrder")]
    partial class AddedDTOOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SINTIA_DWI_ARGANI.Models.DB.Cashier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierStatus = 0,
                            CreatedAt = new DateTime(2025, 4, 23, 10, 41, 52, 149, DateTimeKind.Utc).AddTicks(9311),
                            Name = "Administrator",
                            PasswordHash = "I4qlWpn6mjlKglccX0Nfr+WstgSJgPJhOYchsGEVxZG7Jp12hY3k6UUam6mNLfkkK/OPyrpK/Axc53RFn2XWkA==",
                            Role = "Admin",
                            Salt = "rJpTLywfLA3srDnIx2vCWQ==",
                            Username = "admin"
                        });
                });
