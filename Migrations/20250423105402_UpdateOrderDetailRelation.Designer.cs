...
namespace SINTIA_DWI_ARGANI.Migrations
{
    ...
    [Migration("20250423105402_UpdateOrderDetailRelation")]
    partial class UpdateOrderDetailRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SINTIA_DWI_ARGANI.Models.DB.Cashier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierStatus = 0,
                            CreatedAt = new DateTime(2025, 4, 23, 10, 54, 0, 807, DateTimeKind.Utc).AddTicks(1539),
                            Name = "Administrator",
                            PasswordHash = "Qmo7aA91EAzFNCjmy/Z1gqepmxriJl0M0ur174P2RB6dDwaC051RQ5lJrWVBM+W2PgN+UFsyHeyErOG6sPr49w==",
                            Role = "Admin",
                            Salt = "DglN0qg6jyFDZAA4JfeMFQ==",
                            Username = "admin"
                        });
                });
