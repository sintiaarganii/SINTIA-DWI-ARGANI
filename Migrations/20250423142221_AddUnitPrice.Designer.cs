...
namespace SINTIA_DWI_ARGANI.Migrations
{
    ...
    [Migration("20250423142221_AddUnitPrice")]
            ...
            modelBuilder.Entity("SINTIA_DWI_ARGANI.Models.DB.Cashier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierStatus = 0,
                            CreatedAt = new DateTime(2025, 4, 23, 14, 22, 19, 629, DateTimeKind.Utc).AddTicks(8981),
                            Name = "Administrator",
                            PasswordHash = "GGzzDyE3qzkRDCi4Frgs4/nyH2uGzJHKbI3ly0F4u0K5Jc14seB516UwY/PYbzLA4h4sSf+BnIFXIEFRrE53SA==",
                            Role = "Admin",
                            Salt = "fG/JI9VW0sbklAlvjAZxTg==",
                            Username = "admin"
                        });
                });
