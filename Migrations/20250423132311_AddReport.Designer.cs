...
namespace SINTIA_DWI_ARGANI.Migrations
{
    ...
    [Migration("20250423132311_AddReport")]
            ...
            modelBuilder.Entity("SINTIA_DWI_ARGANI.Models.DB.Cashier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierStatus = 0,
                            CreatedAt = new DateTime(2025, 4, 23, 13, 23, 10, 517, DateTimeKind.Utc).AddTicks(8004),
                            Name = "Administrator",
                            PasswordHash = "QZZeedfwvfKcsh+qu11V4OOdXQXPbkjap+IHbHcqIdhbv1C4krmnClDfGs1TlINnGhxVJAJATxntVCISwbH3Qw==",
                            Role = "Admin",
                            Salt = "fsfkYCHRq5L4weatKlazlA==",
                            Username = "admin"
                        });
                });
