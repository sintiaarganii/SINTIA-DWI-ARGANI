...
namespace SINTIA_DWI_ARGANI.Migrations
{
    ...
    [Migration("20250423112732_AddTotalPriceAndStock")]
    partial class AddTotalPriceAndStock
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SINTIA_DWI_ARGANI.Models.DB.Cashier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierStatus = 0,
                            CreatedAt = new DateTime(2025, 4, 23, 11, 27, 29, 780, DateTimeKind.Utc).AddTicks(8404),
                            Name = "Administrator",
                            PasswordHash = "0zG4I1DMY6ZzwHlfHjtRhO+NL0esxbz/J6mo45YBcbElgj6nM+4wrfsNL2rkZxcqhaxxK3SYg0jl+QyrMLIx7Q==",
                            Role = "Admin",
                            Salt = "+UnYftTpOFfX1xeJItSCOQ==",
                            Username = "admin"
                        });
                });
